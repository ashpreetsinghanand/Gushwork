      ...
      <div class="w-1/3 h-screen relative bg-[#785cfa] ">
        ...
        <div class="absolute inset-0   mt-2 flex flex-col justify-between ">
          ...
          <div class="mb-4 text-center">
            <h1 class="text-6xl font-bold text-white ">Book</h1>
          </div>
      ...
      <div class="w-2/3 bg-gray-100 rounded-r-md">
        ...
        <div class="flex flex-col items-center justify-center h-screen">
          <div class="w-full max-w-md">
              ...
              <div className='flex justify-center mb-5 text-center w-full gap-x-7'>
                <GoogleLogin
                className='w-full'
                    ...
                    />
                      ...
                      <p className='text-md text-center font-[500]'>Only google Login will work</p>
